...
- 복잡한 도해나 그림이 필요할 경우 지문에 구체적인 연출 묘사를 추가해 주세요.`,
      ...
      {
        guide_id: 'guide-2',
        title: '촬영 안내 — 준비물과 진행 방식',
        category: '촬영 안내',
        content: `### 촬영 개요
모든 연수 콘텐츠는 원고가 최종 확정된 뒤 스튜디오 촬영으로 진행됩니다. 강사님은 확정된 원고를 바탕으로 촬영에 참여하시며, 촬영 분량은 차시당 약 8~15분입니다.

촬영 일정은 원고 확정 후 담당 기획자가 강사님과 협의하여 정합니다.

#### 복장
- 단색 계열의 상의를 권장합니다.
- 잔무늬나 큰 로고가 있는 의상은 화면에서 어른거려 피해 주세요.
- 크로마키 배경과 겹치는 초록·파랑 계열은 피해 주세요.
- 액세서리는 최소화해 주세요.

#### 준비물
- 확정된 원고 (출력본 또는 태블릿)
- 강의에 사용할 실물 자료가 있다면 미리 알려 주세요.

### 촬영 당일 진행
- 도착 후 메이크업과 마이크 착용에 약 30분이 걸립니다.
- 프롬프터를 제공하므로 원고를 모두 암기하실 필요는 없습니다. 다만 자연스러운 전달을 위해 흐름은 숙지해 주세요.
- 중간에 끊어서 다시 찍을 수 있으니 편하게 진행하시면 됩니다.

### 촬영 후
편집본은 약 2주 뒤 공유되며, 검토 의견은 문의함으로 남겨 주시면 됩니다.`,
        author: '김기획 기획자',
